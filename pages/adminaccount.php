...
?>
<div id="secondnav">
    <div id="innernav1" class="innernav"><a style="<?php if(preg_match("#clients#", $page)) echo $style ?>" href="adminaccount.php">Clients</a></div>
    <div id="innernav2" class="innernav"><a style="<?php if(preg_match("#commands#", $page)) echo $style ?>" href="adminaccount.php?page=commands">Commandes</a></div>
    <div id="innernav3" class="innernav"><a style="<?php if(preg_match("#cities#", $page)) echo $style ?>" href="adminaccount.php?page=cities">Produits & Villages</a></div>
</div>
<?php
if(preg_match("#clients#", $page)) {
