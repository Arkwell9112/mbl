...
<article id="firstarticle">
    ...
    <ul>
        <li>Votre pain est livré directement chez vous !</li><br>
        <li>Faites du bien à la planète en utilisant moins votre voiture !</li><br>
...
<article>
    ...
    <ul>
        <li>Plus besoin de se déplacer ! Le pain vient à vous !</li><br>
        <li>Une tâche de moins à faire dans le journée c'est plus de repos à la fin !</li><br>
...
<article id="lastarticle">
    ...
    <ul>
        <li>Remettez de l'argent sur votre compte pain sans vous déplacer !</li><br>
        <li>Rechargez aussi votre solde en boutique !</li><br>
